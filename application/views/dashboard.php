                ...
                <div class="box-body">
                  ...
                  <div class="direct-chat-contacts">
                    <ul class="contacts-list">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<?php echo base_url('assets/adminlte/dist'); ?>/img/user5-128x128.jpg" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<?php echo base_url('assets/adminlte/dist'); ?>/img/user6-128x128.jpg" alt="User Image">
                      ...
                      <li>
                        <a href="#">
                          <img class="contacts-list-img" src="<?php echo base_url('assets/adminlte/dist'); ?>/img/user8-128x128.jpg" alt="User Image">
