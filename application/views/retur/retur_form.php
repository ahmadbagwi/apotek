        	    ...
        	    <div class="form-group" style="display: none">
                 ...
                 <div class="form-group">
                        ...
                        <input type="text" class="namaSupplier form-control" name="namaSupplier" id="namaSupplier">
                    </div>
        	    <div class="form-group" style="display: none">
        	    ...
        	    <div class="form-group">
                    <label for="varchar">Produk <?php echo form_error('namaProduk') ?></label>
                    <input type="text" class="form-control" name="namaProduk" id="namaProduk" value="<?php echo $namaProduk; ?>" />
                </div>
        	    <div class="form-group" style="display: none">
