...
class Transaksi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('transaksi/transaction_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'transaction_qty' => $row->transaction_qty,
            ...
            $this->load->view('transaksi/transaction_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->load->view('transaksi/transaction_form', $data);
    }
    ...
    {
	$this->form_validation->set_rules('transaction_date', 'transaction date');
